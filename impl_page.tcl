...
set page_num 15
set freq "150M"
set operator bc0_gen_0
set benchmark bnn512
set page_name "page$page_num" 
set part xcu50-fsvh2104-2-e
set page_dcp "output/bc0_gen_0_syn.dcp"
set context_dcp "input/abstract_shell/bc0_gen_0_overlay.dcp"
set inst_name "level0_i/ulp/ydma_1/mono_inst/bc0_gen_0_inst"
set bit_name "output/${operator}.bit"
set logFileId [open ./runLogImpl_${operator}.log "w"]
set place_dcp "./output/${page_name}_design_place.dcp"
set route_dcp "./output/${page_name}_design_route.dcp"
...
set_property SCOPED_TO_CELLS { level0_i/ulp/ydma_1/mono_inst/bc0_gen_0_inst } [get_files $page_dcp]
...
link_design -mode default -reconfig_partitions { level0_i/ulp/ydma_1/page15_inst } -part $part -top level0_wrapper
link_design -mode default -reconfig_partitions { level0_i/ulp/ydma_1/page15_inst } -part $part -top level0_wrapper
link_design -mode default -reconfig_partitions { level0_i/ulp/ydma_1/page15_inst } -part $part -top level0_wrapper
